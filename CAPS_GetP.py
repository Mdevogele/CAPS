...
def Analyse(Target,Instrum):
    ...
    f.write(str(np.median(JD)) + '\t' + str(np.median(Alpha)) + '\t' + str(np.median(Q)) + '\t' + str(np.median(U)) + '\t' + str(np.median(P_Final)) + '\t' + str(np.median(Pr)) + '\n')
    print(str(np.median(JD)) + '\t' + str(np.median(Alpha)) + '\t' + str(np.median(Q)) + '\t' + str(np.median(U)) + '\t' + str(np.median(P_Final)) + '\t' + str(np.median(Pr)) + '\n')       
...
#    U1=[]
#    U1_Ind=[]
#    U1_Ind.append(list(np.where(Retarder==22)[0]))
#    U1_Ind.append(list(np.where(Retarder==202)[0]))
#    U1_Ind = sum(U1_Ind,[])
#    
#    U2=[]
#    U2_Ind=[]
#    U2_Ind.append(list(np.where(Retarder==67)[0]))
#    U2_Ind.append(list(np.where(Retarder==247)[0]))
#    U2_Ind = sum(U2_Ind,[])
#
#    U3=[]
#    U3_Ind=[]
#    U3_Ind.append(list(np.where(Retarder==112)[0]))
...
#    U4=[]
#    U4_Ind=[]
#    U4_Ind.append(list(np.where(Retarder==157)[0]))
